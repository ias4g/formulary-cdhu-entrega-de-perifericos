      ...
      <header className="w-full flex flex-col mb-2 items-center space-y-4">
        ...
        <div className="w-full flex flex-col items-center justify-center space-y-2">
          <h1 className="text-xl uppercase font-bold">
            FORMULÁRIO DE CONTROLE DE PATRIMÔNIO
          </h1>
        ...
        <div className="grid grid-cols-4 gap-4 w-full">
          <div className="space-y-1">
            ...
            <Select onValueChange={(e) => setHasAccessory(e)}>
              ...
              <SelectContent>
                <SelectItem className="text-[0.7rem]" value="SIM">
                  SIM
                </SelectItem>
                <SelectItem className="text-[0.7rem]" value="NÃO">
                  NÃO
                </SelectItem>
              </SelectContent>
            </Select>
          ...
          <div className="space-y-1">
            ...
            <Select onValueChange={setStatus}>
              ...
              <SelectContent>
                <SelectItem className="text-[0.7rem]" value="ENTREGA">
                  ENTREGA
                </SelectItem>
                <SelectItem className="text-[0.7rem]" value="DEVOLUÇÃO">
                  DEVOLUÇÃO
                </SelectItem>
              </SelectContent>
            </Select>
          ...
          <div className="space-y-1">
            <Label className="uppercase text-[0.7rem]">
              Faltou algum item?
            </Label>
